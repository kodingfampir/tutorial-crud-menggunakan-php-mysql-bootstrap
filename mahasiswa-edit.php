                  ...
                  <div class="form-horizontal">
                    <form name="form1" id="form1" method="post" action="action.php" enctype="multipart/form-data" autocomplete="off">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $data['nama'] ?>" required number="true">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <select class="form-control" id="jkel" name="jkel">
                            <option>--pilih--</option>
                            <!-- Kondisi jika value cocok maka munculkan "selected" pada element html sehingga option aktif -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input type="number" class="form-control" id="umur" name="umur" value="<?php echo $data['umur'] ?>" required>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="nama" class="col-sm-2 control-label">Alamat</label>
                        <div class="col-sm-7">
                          <textarea type="text" class="form-control" id="alamat" name="alamat" required><?php echo $data['alamat'] ?></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="simpan" class="col-sm-2 control-label"></label>
                        <div class="col-sm-7">
                          <button type="submit" class="btn btn-success" name="Edit" id="Edit" value="Edit"><i class="fa fa-save"></i> Edit</button>
                        </div>
                      </div>
